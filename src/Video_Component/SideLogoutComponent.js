...
const SideLogoutComponent = () => {
        return (
            <div style={{ padding: '16px', height: '100%' }}>
                ...
                <div className="user-profile-upload-3030">
                    ...
                    <div className="flex-gap-alignment-dis-4040">
                        ...
                        <Card size="small" className="reminder-card-interaction-1243" title="Reminders"
                            extra={<Badge offset={[-4, 3]} dot>
                                <BellOutlined style={{ fontSize: 16 }} />
                            </Badge>}>
                            <div className="reminders-time-details-schedule-566G">
                                <div className="card-remainerder-1-30304">
                                    <ExclamationCircleTwoTone twoToneColor="#ff606d" />
                                </div>
                                <div className="flex-d-404FDS">
                                    <Text strong>Eng - Vocabulary test</Text>
                                    <Text type="secondary">24 Sep 2021, Friday</Text>
                                </div>
                            </div>
                            <div className="reminders-time-details-schedule-566G">
                                <div className="card-remainerder-2-30304">
                            ...
                            <div className="reminders-time-details-schedule-566G">
                                <div className="card-remainerder-3-30304">
